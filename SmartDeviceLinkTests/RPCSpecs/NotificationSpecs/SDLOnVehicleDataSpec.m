...
describe(@"Getter/Setter Tests", ^ {
    ...
    it(@"should correctly initialize with init", ^ {
        ...
        testNotification.seatOccupancy = seatOccupancy;
        ...
        expect(testNotification.seatOccupancy).to(equal(seatOccupancy));
    });
...
#pragma clang diagnostic pop
    ...
    it(@"Should return nil if not set", ^ {
        ...
        expect(testNotification.seatOccupancy).to(beNil());
    });
